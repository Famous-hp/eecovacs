...
public class PageFilter extends HttpServlet implements Filter{//记得集成和声明
    public void doFilter(ServletRequest req, ServletResponse resp,
        ...
        Users users = (Users) session.getAttribute("users");//获取登录时存放的session
        ...
        }else if(users == null && url.indexOf("/manageweb/htlogin.jsp")== -1 && !url.equals("/manageweb/LoginTel")){
            //未登陆、当前不是登陆的html、也不是登陆的.do//判断条件可以酌情添加

            String location = "/htlogin.jsp";//定义当访客非法访问不被允许的地址时跳转的界面
