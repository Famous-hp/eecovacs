...
<div class="container-fluid ">
	<div class="row col-lg-12 top2 ">
		...
		&nbsp;&nbsp;你现在的位置是：<a href="sort.html">类别页面</a>
	</div>
	<div class="row top1">
		<form action="" class="form-horizontal ">
			<div class="form-group">
	            <span class="col-sm-2 text-right">分类：</span>
	            <div class="col-sm-3 all_fast">
                    <c:forEach items="${sortlist}" var="s">
                        <span name="${s.sortId}">${s.sortName}</span>
                    </c:forEach>
	            </div>
	        ...
	        <div class="form-group">
	            <span class="col-sm-2 text-right">添加分类：</span>
	            <div class="col-sm-3">
	                <input class="form-control " name="new_sort" type="text" required="required" onkeyup="this.value=this.value.replace(/\s+/g,'')"/>
	            </div>
	            <span></span>
	        </div>
...
<script type="text/javascript">
	$(function(){
            ...
            $("[name='new_sort']").blur(function(){
                var name = $("[name='new_sort']").val().trim();
                if(name == ""){
            ...
            $(".ok").click(function(){
                var sid = $('[name=ff]').val();
                window.location.href = "delsort?sid="+sid;
            });
