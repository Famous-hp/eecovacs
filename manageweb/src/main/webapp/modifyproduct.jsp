...
<div class="container-fluid ">
	<div class="row col-lg-12 top2 ">
		...
		&nbsp;&nbsp;你现在的位置是：<a href="modifyproduct.jsp">商品修改页面</a>
	</div>
	<div class="row top1">
		<form action="Modify" method="post" class="form-horizontal ">
			...
			<div style="color: white;">
					...
					<div class="form-group" >
						<input hidden value="${p.prid}" name="prid">
						<span class="col-sm-2 text-right"> 功能：</span>
						<div class="col-sm-2">
							<input class="form-control" value="${p.function}" name="function" type="text" required="required" onkeyup="this.value=this.value.replace(/\s+/g,'')"/>
						</div>

						<span class="col-sm-1 text-right"> 续航时间（小时）：</span>
						<div class="col-sm-2">
							<input class="form-control" value="${p.endurance}" name="time" type="text" required="required" onkeyup="this.value=this.value.replace(/\s+/g,'')"/>
						</div>
					...
					<div class="form-group" style="margin-top: 10px;">
						...
						<div class="col-sm-2">
							<input class="form-control" value="${p.mah}" name="mah" type="text" required="required" onkeyup="this.value=this.value.replace(/\s+/g,'')"/>
						</div>

						<span class="col-sm-1 text-right"> 额定功率（W）：</span>
						<div class="col-sm-2">
							<input class="form-control" value="${p.w}" name="ww" type="text" required="required" onkeyup="this.value=this.value.replace(/\s+/g,'')"/>
						</div>
					...
					<div class="form-group" style="margin-top: 10px;">
						...
						<div class="col-sm-2">
							<input class="form-control" value="${p.v}" name="vv" type="text" required="required" onkeyup="this.value=this.value.replace(/\s+/g,'')"/>
						</div>

						<span class="col-sm-1 text-right"> 充电时间 （小时）：</span>
						<div class="col-sm-2">
							<input class="form-control" value="${p.time}" name="hh" type="text" required="required" onkeyup="this.value=this.value.replace(/\s+/g,'')"/>
						</div>
					...
					<div class="form-group" style="margin-top: 10px;">
						...
						<div class="col-sm-2">
							<input class="form-control" value="${p.sound}" name="sound" type="text" required="required" onkeyup="this.value=this.value.replace(/\s+/g,'')"/>
						</div>
						...
						<div class="col-sm-2">
							<input class="form-control" value="${p.l}"  name="ll" type="text" required="required" onkeyup="this.value=this.value.replace(/\s+/g,'')"/>
						</div>
					...
					<div class="form-group" style="margin-top: 10px;">
						...
						<div class="col-sm-2">
							<input class="form-control" value="${p.kg}" name="kg" type="text" required="required" onkeyup="this.value=this.value.replace(/\s+/g,'')"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<textarea name="destory" style="width: 100%;color: #000000;">${p.describes}</textarea>
						</div>
			...
			<div class="col-md-offset-5 col-sm-1 saves" >
				<input class=" form-control btn-primary " type="submit" id="submit" value="&nbsp;确认" style="margin-bottom: 33px;"/>
			</div>
			<div class="col-sm-1">
